...
class MyListsViewModel(val context: Context, val db:AppDatabase, val auth: FirebaseAuth): ViewModel() {
    ...
    //var listOfLists = db.giftListDao().getAll().stateIn(viewModelScope, SharingStarted.Lazily, emptyList())
    init{
